...
public class MyBatisProcessor {
    ...
    void refProxyClasses(BuildProducer<ReflectiveClassBuildItem> reflectiveClass,
        ...
        reflectiveClass.produce(new ReflectiveClassBuildItem(true, true, RawSqlSource.class));
        ...
        //TODO move to grpc extend call
        reflectiveClass.produce(new ReflectiveClassBuildItem(true, true, PagedQuery.class));
